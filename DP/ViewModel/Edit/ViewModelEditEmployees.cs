...
{
    class ViewModelEditEmployees : ViewModelBase
    {
        ...
        public ViewModelEditEmployees(CommonClass cc) : base()
        {
            ...
            SelectedProfession = Professions.IndexOf(Professions.Where( x => x.Profession_ID == cc.Profession_ID).FirstOrDefault());
        ...
        private void SaveCommandExecute()
        {
            ...
            try
            {
                ...
                Emp.Office_ID = Offices[SelectedOffice].Office_ID;
                Emp.Profession_ID = Professions[SelectedProfession].Profession_ID;
                Emp.Full_Name_Employee = Full_Name_Employee;
